          ...
          return (
            <article key={archetype.id} className="paper-card rounded p-5">
              ...
              <div className="mt-5 grid gap-5 lg:grid-cols-2">
                <div>
                  <h3 className="font-serif text-xl font-semibold text-ink">Formulae</h3>
                  <div className="mt-3 space-y-2">
                    {archetype.formulae.map((formula) => <MathBlock key={formula} formula={formula} />)}
                  </div>
                </div>
                <div>
                  <h3 className="font-serif text-xl font-semibold text-ink">Step-by-step algorithm</h3>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                <div className="rounded border border-ink/10 bg-white/65 p-4">
                  <h3 className="font-serif text-lg font-semibold text-ink">Generated practice</h3>
                  <p className="mt-2 text-sm leading-6 text-graphite">{archetype.practice}</p>
                </div>
                <div className="rounded border border-ink/10 bg-white/65 p-4">
                  <h3 className="font-serif text-lg font-semibold text-ink">Exam answer template</h3>
